...
int main()
{
    ...
    */
    ...
    /*void* ptr = glMapBuffer(cubeVBO, GL_WRITE_ONLY);
    ...
    unsigned int uniformBlockIndexModel = glGetUniformBlockIndex(shader.ID, "Matrices");
    unsigned int uniformBlockIndexView = glGetUniformBlockIndex(shader.ID, "Matrices");
    unsigned int uniformBlockIndexProjection = glGetUniformBlockIndex(shader.ID, "Matrices");

    /*unsigned int uniformBlockIndexModel = glGetUniformBlockIndex(skyboxShader.ID, "Matrices");
    unsigned int uniformBlockIndexView = glGetUniformBlockIndex(skyboxShader.ID, "Matrices");
    unsigned int uniformBlockIndexProjection = glGetUniformBlockIndex(skyboxShader.ID, "Matrices");*/

    glUniformBlockBinding(shader.ID, uniformBlockIndexModel, 0);
    glUniformBlockBinding(shader.ID, uniformBlockIndexView, 0);
    glUniformBlockBinding(shader.ID, uniformBlockIndexProjection, 0);

    /*glUniformBlockBinding(skyboxShader.ID, uniformBlockIndexModel, 0);
    glUniformBlockBinding(skyboxShader.ID, uniformBlockIndexView, 0);
    glUniformBlockBinding(skyboxShader.ID, uniformBlockIndexProjection, 0);*/
    ...
    glBindBufferRange(GL_UNIFORM_BUFFER, 0, uboBlock, 0, 3 * sizeof(glm::mat4));
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glBindBuffer(GL_UNIFORM_BUFFER, uboBlock);      // OpenGL 420 버전 사용해야 binding 가능
